...
void setup() {
  ...
  //song = minim.loadFile("Ariana Grande - One Last Time (Lyric Video).mp3", 1024);
...
void draw() {
  ...
  /* This uses the FFT to determine the frequencies present; then the 10 lowest frequence bands
